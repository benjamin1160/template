...
export default function ValueStack({ valueStack }: ValueStackProps) {
  ...
  return (
    <section id="offer" className="bg-[#0a0a0a] py-20 md:py-32">
      <div className="mx-auto max-w-4xl px-6 sm:px-8">
        ...
        <div className="overflow-hidden rounded-2xl border border-[#404040] bg-[#141414]">
          <ul className="divide-y divide-[#262626]">
            {valueStack.items.map((item, i) => (
              <li key={i} className="flex gap-4 p-5 sm:p-6 items-start">
                <div className="mt-0.5 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-[#ffd800]">
                  <svg
                    viewBox="0 0 20 20"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {item.description && (
                    <p className="mt-1 text-sm sm:text-base text-[#a3a3a3]">
                      {item.description}
                    </p>
                  )}
                </div>
          ...
          <div className="border-t border-[#404040] bg-[#1c1c1c] px-6 py-6 sm:px-8">
            <div className="flex items-baseline justify-between gap-4 pb-4 border-b border-[#262626]">
              <span className="text-sm sm:text-base font-semibold uppercase tracking-wider text-[#a3a3a3]">
                {totalLabel}
              </span>
            ...
            <div className="flex items-baseline justify-between gap-4 pt-5">
              ...
              <span className="display text-4xl sm:text-5xl md:text-6xl text-[#ffd800] tabular-nums">
                {priceText}
              </span>
            </div>
          </div>
